...
az deployment group create --name aks-gh-self-hosted-runner -f iac/bicep/gh/gh-self-hosted-runner.bicep -g ${{ env.RG_APP }} \
...
param linuxVMName string = 'vm-linuxpetcliaks'
...
param nsgName string = 'nsg-aks-${appName}-app-client'
